...
export const MyPools = observer(() => {
  return (
    <div className="w-full relative custom-dashed-3xl bg-white p-6">
      <div className="text-xl sm:text-4xl absolute top-10 sm:top-8 left-6">My Pools</div>
      <Tabs
        classNames={{
          base: "relative w-full",
          tabList:
            "flex rounded-2xl border border-[#202020] bg-white p-2 sm:px-4 sm:py-2 shadow-[4px_4px_0px_0px_#202020,-4px_4px_0px_0px_#202020] mb-6 ml-auto z-10",
