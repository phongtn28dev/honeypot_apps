...
import { footerData } from '@honeypot/shared/config/allAppPath';
...
export const CurrentPageFooter = () => {
  ...
  return (
    footer ?? (
      <div className="bg-[url('/images/footer.png')] mt-[120px] min-h-[200px] bg-cover bg-no-repeat bg-center relative">
        <Image
