  ...
  [9754, 9685],
  {
    ...
    26996: (e, t, n) => {
      ...
      function a(e) {
        ...
        return o.createElement(
          "span",
          { className: s(i().loader, l && i().static, t) },
    ...
    89324: (e, t, n) => {
      ...
      n.r(t),
        n.d(t, {
          ...
          showSymbolSearchItemsDialog: () => i.showSymbolSearchItemsDialog,
        });
      var o = n(82992),
        s = (n(32563), n(31330)),
        l = n(65106),
      ...
      function c(e) {
        ...
        const t = (0, l.getSymbolSearchCompleteOverrideFunction)(),
          ...
          v = {
            ...u,
            showSpreadActions: null != r ? r : (0, s.canShowSpreadActions)(),
        ...
        (0, i.showSymbolSearchItemsDialog)({ ...v, defaultValue: n });
      }
      const h = {
    ...
    72539: (e, t, n) => {
      "use strict";
      n.r(t), n.d(t, { GlobalSearchDialogRenderer: () => Xe });
      var o = n(50959),
        s = n(962),
        l = n(98310),
        i = n(85067),
      ...
      function S(e) {
        const { text: t, showIcon: n = !0, className: s } = e,
          l = g.watchedTheme.value() === p.StdTheme.Dark ? w : b;
        return o.createElement(
          "div",
          { className: v(f.wrap, s) },
          n && o.createElement(m.Icon, { icon: l, className: f.image }),
          o.createElement("span", { className: f.text }, t)
        );
      }
      var y = n(35057),
        E = n(63651),
        ...
        A = n(10772),
        I = n(32108);
      const H = (0, M.mergeThemes)(_.DEFAUL_CONTEXT_MENU_ITEM_THEME, I);
      function L(e) {
        const { action: t, isSelected: n, activeElRef: s, onExecute: l } = e;
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              "tr",
              null,
              o.createElement("td", { className: T.heading }, t)
            ),
            s.map((e) =>
              o.createElement(L, {
                key: e.id,
      ...
      var N = n(61213);
      const P = [
        { name: "drawingsActions", label: r.t(null, void 0, n(22772)) },
        { name: "functionActions", label: r.t(null, void 0, n(15327)) },
        { name: "settingsActions", label: r.t(null, void 0, n(89517)) },
      ];
      function O(e) {
        const { dialogId: t, items: s, onClose: l, shouldReturnFocus: i } = e,
          [v, m] = (0, o.useState)(""),
          [p, g] = (0, o.useState)([]),
          b = (0, o.useRef)(null),
          w = (0, o.useRef)(null),
          { activeIdx: f, setActiveIdx: C } = (0, E.useKeyboardNavigation)(
            b.current,
            p,
            function (e, t) {
              t.preventDefault();
              ...
              n &&
                !n.isDisabled() &&
                (n.execute(), n.isCheckable() ? _() : l());
            },
            "keyup"
          );
        (0, k.useResetActiveIdx)(C, [v, s]),
          (0, x.useScrollToRef)(w, f),
          (0, o.useEffect)(() => {
            var e;
          ...
          (0, o.useEffect)(() => {
            ...
            if (e)
              return (
                ...
                L(),
                () => {
                  e && e.removeEventListener("input", L);
                }
              );
          }, []);
        const M = (0, o.useCallback)(
          ...
          _ = (0, o.useCallback)((0, a.default)(l, 200), []);
        (0, o.useEffect)(
          () => () => {
            M.flush(), _.cancel();
          },
        ...
        return o.createElement(y.AdaptivePopupDialog, {
              ...
              o.createElement(
                ...
                v
                  ...
                  : o.createElement(
                      ...
                      Boolean(p.length)
                        ? o.createElement(D, {
                            heading: r.t(null, void 0, n(90612)),
                            selectedId: T(),
                            activeElRef: w,
                            items: p,
                            onExecute: H,
          ...
          onKeyDown: function (e) {
            27 === (0, h.hashFromEvent)(e) && (e.preventDefault(), l());
          },
          isOpened: !0,
        });
        function H(e) {
          e.getState().checkable ? _() : l();
        }
        function L() {
      ...
      var R = n(82992),
        ...
        B = n(10638),
        F = n(14483),
        Z = (n(92249), n(28853), n(39347));
      class G extends Z.Action {
        constructor({
          id: e,
          category: t,
          favourite: n,
      ...
      function $(e) {
        ...
        return (
          ...
          (function (e, t) {
            ...
            const [s, l, i] = n,
              [a, r, c] = o;
            return s !== a ? s < a : l !== r ? l < r : i !== c && i < c;
          })(t, e)
        );
      }
      const ee = (e) => {
        const t = (t) => {
          ...
          if (
                ...
                o.push(
                  new G({
                    ...
                    label: `${r.t(
                      ...
                      void 0,
                      n(32409)
                    )} ${q.translateStdThemeName(t)}`,
                    onExecute: () => {
                      q.loadTheme(e.chartWidgetCollection(), {
                        themeName: t,
                        standardTheme: !1,
                      }).then(() => {
            ...
            !(0, Q.isDesktopApp)() || $("1.0.10"))
          ) {
            const [t, s] = q.getStdThemeNames();
            o.push(
              new G({
                id: "DarkColorTheme",
                category: "settingsActions",
                label: r.t(null, void 0, n(66365)),
                checkable: !0,
                checked: q.getCurrentTheme().name === s,
                onExecute: () => {
                  const n = q.getCurrentTheme().name === s ? t : s;
                  q.loadTheme(e.chartWidgetCollection(), {
                    themeName: n,
                    standardTheme: !0,
                  }).then(() => {
      ...
      const { DrawingSyncMode: ie } = te,
        ...
        re = new W.TranslatedString(
          "stay in drawing mode",
          r.t(null, void 0, n(52010))
        ),
        ce = new W.TranslatedString(
          "sync drawings",
          r.t(null, void 0, n(95612))
        ),
        he = r.t(null, void 0, n(49421)),
        de = r.t(null, void 0, n(35888)),
        ue =
          (r.t(null, void 0, n(77989)),
          r.t(null, void 0, n(19407)),
          r.t(null, void 0, n(37057))),
        ve = r.t(null, void 0, n(45265)),
        me = r.t(null, void 0, n(85422));
      var pe = n(5894),
        ge = n(64358),
        be = n(89324);
      class we extends G {
      ...
      const ye = F.enabled("show_average_close_price_line_and_label"),
        Ee = new W.TranslatedString(
          "change session",
          r.t(null, void 0, n(65303))
        ),
        xe = new W.TranslatedString(
          "change plus button visibility",
          r.t(null, void 0, n(50190))
        ),
        ke = new W.TranslatedString(
          "change countdown to bar close visibility",
          r.t(null, void 0, n(58108))
        ),
        Ce = new W.TranslatedString(
          "scale price chart only",
          r.t(null, void 0, n(99042))
        ),
        Me = new W.TranslatedString(
          "change symbol last value visibility",
          r.t(null, void 0, n(53150))
        ),
        _e = new W.TranslatedString(
          "change high and low price labels visibility",
          r.t(null, void 0, n(66805))
        ),
        Ae = new W.TranslatedString(
          "change average close price label visibility",
          r.t(null, void 0, n(39402))
        ),
        Ie = new W.TranslatedString(
          "change indicators and financials value labels visibility",
          r.t(null, void 0, n(90512))
        ),
        He = new W.TranslatedString(
          "change indicators and financials name labels visibility",
          r.t(null, void 0, n(59820))
        ),
        Le = new W.TranslatedString(
          "change high and low price lines visibility",
          r.t(null, void 0, n(92556))
        ),
        Te = new W.TranslatedString(
          "change average close price line visibility",
          r.t(null, void 0, n(98866))
        ),
        De = new W.TranslatedString(
          "change symbol labels visibility",
          r.t(null, void 0, n(9402))
        ),
        Ne =
          (new W.TranslatedString(
            "change pre/post market price label visibility",
            r.t(null, void 0, n(49889))
          ),
          new W.TranslatedString(
            "change symbol previous close value visibility",
            r.t(null, void 0, n(12707))
          ),
          new W.TranslatedString(
            "change previous close price line visibility",
            r.t(null, void 0, n(59883))
          )),
        Pe =
          (new W.TranslatedString(
            "change bid and ask labels visibility",
            r.t(null, void 0, n(5100))
          ),
          new W.TranslatedString(
            "change bid and ask lines visibility",
            r.t(null, void 0, n(32311))
          ),
          new W.TranslatedString(
            "change pre/post market price lines visibility",
            r.t(null, void 0, n(50393))
          ),
          new W.TranslatedString(
            "change price line visibility",
            r.t(null, void 0, n(67761))
          )),
        Oe = new W.TranslatedString(
          "change session breaks visibility",
          r.t(null, void 0, n(15403))
        ),
        Re =
          (new W.TranslatedString(
            "change ideas visibility on chart",
            r.t(null, void 0, n(65558))
          ),
          new W.TranslatedString("show all ideas", r.t(null, void 0, n(13622))),
          new W.TranslatedString(
            "show ideas of followed users",
            r.t(null, void 0, n(26267))
          ),
          new W.TranslatedString(
            "show my ideas only",
            r.t(null, void 0, n(40061))
          ),
          new W.TranslatedString(
            "change events visibility on chart",
            r.t(null, void 0, n(79574))
          ),
          new W.TranslatedString(
          ...
          new W.TranslatedString(
            ...
            r.t(null, void 0, n(84944))
          ),
          new W.TranslatedString(
            "change splits visibility",
            r.t(null, void 0, n(74488))
          ),
          {
            0: r.t(null, void 0, n(97559)),
            1: r.t(null, void 0, n(86771)),
            9: r.t(null, void 0, n(51383)),
            2: r.t(null, void 0, n(87691)),
            14: r.t(null, void 0, n(14956)),
            15: r.t(null, void 0, n(59393)),
            3: r.t(null, void 0, n(45290)),
            16: r.t(null, void 0, n(41412)),
            4: r.t(null, void 0, n(91664)),
            7: r.t(null, void 0, n(470)),
            5: r.t(null, void 0, n(90599)),
            6: r.t(null, void 0, n(59491)),
            8: r.t(null, void 0, n(20424)),
            10: r.t(null, void 0, n(18779)),
            11: r.t(null, void 0, n(38385)),
            12: r.t(null, void 0, n(28381)),
            13: r.t(null, void 0, n(20788)),
            17: r.t(null, void 0, n(82838)),
          });
      async function ze(e) {
        var t, o, s, l, i, a, c, d;
        const u = [],
          [v, m] = await Promise.all([ee(e), Promise.resolve(null)]),
          p = ((e) => {
            const t = [],
              {
                stayInDrawingMode: n,
            ...
            t.push(
              new G({
                ...
                category: "settingsActions",
                onExecute: () => {
                  e.model().setProperty(n, !n.value(), re);
                },
              })
            ),
              t.push(
                new G({
                  ...
                  onExecute: () => {
                    e.model().setProperty(o, !o.value(), ce);
                  },
                })
              );
            const l = te.lockDrawings();
            t.push(
              new G({
                label: ue,
                checkable: !0,
                ...
                checked: l.value(),
                onExecute: () => {
                  te.lockDrawings().setValue(!te.lockDrawings().value());
                },
              })
            );
            const i = (0, le.getSavedHideMode)();
            t.push(
              ...Array.from((0, le.getHideOptions)()).map(
                ([e, t]) =>
                  new G({
                    ...
                    id: ae[e],
                    category: "settingsActions",
                    checked: i === e && (0, le.getHideModeStateValue)(e),
                    onExecute: () => (0, le.toggleHideMode)(e),
                  })
              )
            );
            const { magnet: a, magnetMode: r } = te.properties().childs();
            return (
              t.push(
                new G({
                  label: ve,
                  ...
                  checked: a.value() && r.value() === oe.MagnetMode.WeakMagnet,
                  icon: se.drawingToolsIcons.magnet,
                  onExecute: () => {
                    a.value() && r.value() === oe.MagnetMode.WeakMagnet
                      ? (0, ne.setIsMagnetEnabled)(!1)
                      : (0, ne.setMagnetMode)(oe.MagnetMode.WeakMagnet);
                  },
                })
              ),
              t.push(
                new G({
                  ...
                  category: "functionActions",
                  checked:
                    a.value() && r.value() === oe.MagnetMode.StrongMagnet,
                  icon: se.drawingToolsIcons.strongMagnet,
                  onExecute: () => {
                    a.value() && r.value() === oe.MagnetMode.StrongMagnet
                      ? (0, ne.setIsMagnetEnabled)(!1)
                      : (0, ne.setMagnetMode)(oe.MagnetMode.StrongMagnet);
                  },
                })
              ),
              t
          ...
          g = (function (e) {
            const t = [];
            return (
              F.enabled("header_widget") &&
                F.enabled("header_compare") &&
                t.push(
                  new G({
                    icon: n(1393),
                    label: (0, V.appendEllipsis)(r.t(null, void 0, n(90069))),
                    id: "Compare",
                    category: "functionActions",
              ...
              F.enabled("header_widget") &&
                F.enabled("header_indicators") &&
                t.push(
                  new G({
                    icon: n(39681),
                    label: (0, V.appendEllipsis)(r.t(null, void 0, n(64642))),
                    id: "InsertIndicator",
                    category: "functionActions",
                    onExecute: () => {
                      e.showIndicators([]);
              ...
              F.enabled("show_object_tree") &&
                t.push(
                  new G({
                    icon: n(19908),
                    label: r.t(null, void 0, n(55149)),
              ...
              F.enabled("header_widget") &&
                F.enabled("header_settings") &&
                t.push(
                  new G({
                    label: (0, V.appendEllipsis)(r.t(null, void 0, n(89517))),
                    icon: n(51983),
                    id: "ChartProperties",
                    category: "functionActions",
                    onExecute: () => {
              ...
              F.enabled("header_widget") &&
                F.enabled("header_symbol_search") &&
                t.push(
                  new G({
                    icon: n(69859),
                    label: (0, V.appendEllipsis)(r.t(null, void 0, n(28089))),
                    id: "ChangeSymbol",
                    category: "functionActions",
                    onExecute: () => {
              ...
              F.enabled("symbol_info") &&
                t.push(
                  new G({
                    label: (0, V.appendEllipsis)(r.t(null, void 0, n(12014))),
                    icon: n(37924),
                    id: "SymbolInfo",
                    category: "functionActions",
                    onExecute: () => {
                      {
                        ...
                        return void (0, pe.showSymbolInfoDialog)(s);
                      }
                    },
                  })
                ),
              e.options().goToDateEnabled &&
                t.push(
                  new G({
                    label: (0, V.appendEllipsis)(r.t(null, void 0, n(40803))),
                    icon: n(90752),
                    id: "GoToDate",
                    category: "functionActions",
                    onExecute: () => {
                      (0, ge.showGoToDateDialog)(e);
                    },
        ...
        u.push(...v, ...p, ...g), m && u.push(...m);
        const b = e.model().mainSeries(),
          w = b.priceScale(),
          f = b.properties().childs(),
          S =
        ...
        u.push(
          new G({
            id: "ResetPriceScale",
            category: "functionActions",
            label: r.t(null, void 0, n(45417)),
            icon: n(39267),
            onExecute: () => {
              S && e.model().resetPriceScale(S, w);
            },
            shortcutHint: (0, h.humanReadableHash)(h.Modifiers.Alt + 82),
          })
        ),
          u.push(new we(e.model())),
          u.push(new fe(e.model())),
          u.push(new Se(e.model()));
        const y = w.isLockScale(),
          E = 6 === f.style.value();
        u.push(
          new G({
            label: r.t(null, void 0, n(31273)),
            checkable: !0,
            ...
            onExecute: () => {
              e.model().setProperty(f.sessionId, "regular", Ee);
            },
            checked: Boolean(
              "regular" ===
                (null === (l = b.symbolInfo()) || void 0 === l
                  ? void 0
                  : l.subsession_id)
            ),
          })
              ...
              disabled: !(null ===
                (a =
                  null === (i = b.symbolInfo()) || void 0 === i
                    ? void 0
                    : i.subsessions) || void 0 === a
                ? void 0
                : a.some((e) => !e.private && "extended" === e.id)),
              onExecute: () => {
                var t;
                const n =
                  "extended" ===
                  (null === (t = b.symbolInfo()) || void 0 === t
                    ...
                    ? "regular"
                    : "extended";
                e.model().setProperty(f.sessionId, n, Ee);
              },
              checked: Boolean(
                "extended" ===
          ...
          u.push(
            new G({
              ...
              checked: w.isLockScale(),
            })
          ),
          u.push(
            new G({
              label: r.t(null, void 0, n(20062)),
              checkable: !0,
          ...
          u.push(
            new G({
              id: "AutoFitsToScreen",
              category: "settingsActions",
              label: r.t(null, void 0, n(28020)),
              checkable: !0,
              onExecute: () => {
                e.model().togglePriceScaleAutoScaleMode(w);
              },
              checked: w.isAutoScale(),
              disabled: w.properties().childs().autoScaleDisabled.value(),
            })
          ),
          u.push(
            new G({
              label: r.t(null, { context: "scale_menu" }, n(72116)),
              checkable: !0,
              id: "ToggleRegularScale",
              category: "settingsActions",
              onExecute: () => {
                e.model().setPriceScaleRegularScaleMode(w);
              },
              disabled: y || E || w.isRegular(),
              checked: w.isRegular(),
            })
          );
        ...
        u.push(
          new G({
            label: k
              ...
              : r.t(null, void 0, n(76300)),
            id: "MoveScaleToSide",
            category: "functionActions",
            disabled: x.left + x.right !== 1,
            onExecute: () => {
              e.model().mergeAllScales(k ? "left" : "right");
            },
          })
        ),
          u.push(
            new G({
              label: r.t(null, void 0, n(78633)),
          ...
          u.push(
            new G({
              label: r.t(null, void 0, n(4037)),
              checkable: !0,
              checked: X.addPlusButtonProperty.value(),
              id: "ToggleAddOrderPlusButton",
              category: "settingsActions",
              onExecute: () => {
                e.model().setProperty(
                  X.addPlusButtonProperty,
                  !X.addPlusButtonProperty.value(),
                  xe
                );
              },
            })
        ...
        u.push(
          new G({
            label: r.t(null, void 0, n(18511)),
            checkable: !0,
            id: "ToggleCountdown",
            category: "settingsActions",
            checked: M.value(),
            onExecute: () => {
              e.model().setProperty(M, !M.value(), ke);
            },
          })
        );
        const _ = C.scaleSeriesOnly;
        u.push(
          new G({
            label: r.t(null, void 0, n(35264)),
            checkable: !0,
            id: "ScalePriceChartOnly",
            category: "settingsActions",
            checked: _.value(),
            onExecute: () => {
              e.model().setProperty(_, !_.value(), Ce);
            },
          })
        );
        ...
        const I = f.highLowAvgPrice.childs();
        u.push(
          new G({
            label: r.t(null, void 0, n(60259)),
            checkable: !0,
            id: "ToggleHighLowPriceLabels",
            category: "settingsActions",
            checked: I.highLowPriceLabelsVisible.value(),
            onExecute: () => {
              e.model().setProperty(
                I.highLowPriceLabelsVisible,
                !I.highLowPriceLabelsVisible.value(),
                _e
              );
            },
          })
          ...
          ye &&
            u.push(
              new G({
                ...
                category: "settingsActions",
                checked: I.averageClosePriceLabelVisible.value(),
                onExecute: () => {
                  const t = !I.averageClosePriceLabelVisible.value();
                  e.model().setProperty(I.averageClosePriceLabelVisible, t, Ae);
                },
              })
            );
        const H = C.showSymbolLabels;
        u.push(
          new G({
            label: r.t(null, void 0, n(79791)),
            checkable: !0,
            id: "ToggleSymbolLabels",
            category: "settingsActions",
            checked: H.value(),
            onExecute: () => {
              e.model().setProperty(H, !H.value(), De);
            },
          })
        );
        const L = (0, J.combineProperty)(
          (e, t) => e || t,
        ...
        u.push(
          ...
          u.push(
            new G({
              label: r.t(null, void 0, n(21803)),
              checkable: !0,
              id: "ToggleHighLowPriceLines",
              category: "settingsActions",
              checked: I.highLowPriceLinesVisible.value(),
              onExecute: () => {
                e.model().setProperty(
                  I.highLowPriceLinesVisible,
                  !I.highLowPriceLinesVisible.value(),
                  Le
                );
              },
            })
          ...
          ye &&
            u.push(
              new G({
                label: r.t(null, void 0, n(87899)),
                checkable: !0,
                id: "ToggleAverageClosePriceLine",
                category: "settingsActions",
                checked: I.averageClosePriceLineVisible.value(),
                onExecute: () => {
                  const t = !I.averageClosePriceLineVisible.value();
                  e.model().setProperty(I.averageClosePriceLineVisible, t, Te);
                },
              })
            );
        const D = f.showPriceLine;
        u.push(
          new G({
            label: r.t(null, void 0, n(99530)),
            checkable: !0,
            id: "TogglePriceLine",
            category: "settingsActions",
            checked: D.value(),
            onExecute: () => {
              e.model().setProperty(D, !D.value(), Pe);
            },
          })
        );
        const N = f.showPrevClosePriceLine;
        u.push(
          new G({
            label: r.t(null, void 0, n(96032)),
            checkable: !0,
            ...
            checked: N.value(),
            onExecute: () => {
              e.model().setProperty(N, !N.value(), Ne);
            },
          })
        ),
          u.push(
            new G({
              label: r.t(null, void 0, n(75521)),
              icon: n(39267),
              id: "ResetTimeScale",
              category: "functionActions",
              onExecute: () => {
        ...
        if (
          (u.push(
            new G({
              ...
              checked: P.value(),
              onExecute: () => {
                e.model().setProperty(P, !P.value(), Oe);
              },
            })
          ),
          u.push(
            new G({
              label: r.t(null, void 0, n(34465)),
              icon: n(39267),
              id: "ResetChart",
              category: "functionActions",
          ...
          F.enabled("header_widget") &&
            F.enabled("header_undo_redo") &&
            (u.push(
              new G({
                id: "Undo",
                category: "functionActions",
                icon: n(77665),
                label: r.t(null, void 0, n(81320)),
                onExecute: () => {
          ...
          F.enabled("header_widget") && F.enabled("header_chart_type"))
        ) {
          const t = (0, K.allChartStyles)();
          for (const n of t)
            u.push(
              new G({
                id: `ChartStyle_${n}`,
        ...
        return (
          F.enabled("header_widget") &&
            F.enabled("header_fullscreen_button") &&
            u.push(
              new G({
                label: r.t(null, void 0, n(11682)),
                id: "Fullscreen mode",
                icon: n(49697),
                category: "functionActions",
                checkable: !0,
      ...
      var Ve = n(71810),
        ...
        Fe = n(80982);
      function Ze() {
        return Fe.lineToolsFlat.map((e) =>
          (function (e) {
            var t;
            const o = Be.lineToolsInfo[e],
              s =
              ...
              l = {
                ...
                icon: o.icon,
                shortcutHint: s ? (0, h.humanReadableHash)(s) : void 0,
                payload: e,
                onExecute: () => te.tool.setValue(e),
                favourite: Ve.LinetoolsFavoritesStore.isFavorite(e),
                onFavouriteClick: (t) => {
                  t.preventDefault(),
                    Ve.LinetoolsFavoritesStore.isFavorite(e)
                      ? Ve.LinetoolsFavoritesStore.removeFavorite(e)
                      : Ve.LinetoolsFavoritesStore.addFavorite(e);
                },
              };
            return (
              e.toLowerCase().includes("fib") &&
                (l.aliases = [r.t(null, void 0, n(22305))]),
              new G(l)
            );
          })(e.name)
        );
      ...
      var We = n(16216);
      class Xe extends i.DialogRenderer {
        constructor() {
          super(),
            (this._actions = []),
            (this.show = (e) => {
              (async function (e) {
                ...
                t.push(...o);
                const c = e.chartWidgetCollection();
                if (
                  F.enabled("header_widget") &&
                  F.enabled("header_resolutions")
                ) {
                  const o = {
                    label: (0, V.appendEllipsis)(r.t(null, void 0, n(8353))),
                    id: "ChangeInterval",
                    category: "functionActions",
                    onExecute: () => {
                  ...
                  !F.enabled("show_interval_dialog_on_key_press") ||
                    e.readOnly() ||
                    e.options().hideSymbolSearch ||
                    (o.shortcutHint = (0, h.humanReadableHash)(188)),
                    t.push(new G(o));
                }
                if (
                  F.enabled("header_widget") &&
                  F.enabled("header_saveload")
                ) {
                  const o = new B.LoadChartService(c);
                  t.push(
                    new G({
                      id: "LoadChartLayout",
                      category: "functionActions",
                      label: (0, V.appendEllipsis)(r.t(null, void 0, n(75687))),
                      onExecute: () => {
                        o.showLoadDialog();
                      },
                      shortcutHint: r.t(null, { context: "hotkey" }, n(14229)),
                    })
                  );
                  ...
                  s &&
                    (t.push(
                      new G({
                        ...
                        category: "functionActions",
                        label: (0, V.appendEllipsis)(
                          r.t(null, void 0, n(4142))
                        ),
                        onExecute: () => {
                          s.renameChart();
                        },
                ...
                return (
                  t.push(
                    new G({
                      ...
                      category: "functionActions",
                      icon: n(72644),
                      label: r.t(null, void 0, n(15803)),
                      onExecute: () => c.takeServerScreenshot(),
                      shortcutHint: (0, h.humanReadableHash)(
                        h.Modifiers.Alt + 83
                      ),
                    })
                  ...
                  .concat(
                    (() => {
                      const e = new G({
                        ...
                        icon: n(81111),
                        label: (0, V.appendEllipsis)(
                          r.t(null, void 0, n(72357))
                        ),
                        onExecute: () => (0, Ge.showManageDrawingsDialog)(),
                      });
                      return F.enabled("left_toolbar") ? [...Ze(), e] : [];
                    })()
                  )
                  .sort(Ue)),
                  s.render(
          ...
          const e = (0, We.service)(l.CHART_WIDGET_COLLECTION_SERVICE);
    ...
    63651: (e, t, n) => {
      "use strict";
      n.d(t, { useKeyboardNavigation: () => l });
      var o = n(50959),
        s = n(68335);
      function l(e, t, n, l = "keydown") {
        ...
        return (
          ...
          (0, o.useEffect)(() => {
            ...
            const o = (e) => {
              var o;
              e.repeat ||
                (13 === (0, s.hashFromEvent)(e) &&
                  n(null !== (o = t[i]) && void 0 !== o ? o : null, e));
            };
            return (
              e.addEventListener(l, o),
              () => {
                e.removeEventListener(l, o);
              }
            );
          }, [e, i, t, n, l]),
    ...
    37404: (e, t, n) => {
      "use strict";
      n.d(t, { showManageDrawingsDialog: () => s });
      let o = null;
      function s(e) {
        return Promise.all([
          n.e(4781),
    ...
    10772: (e, t, n) => {
      ...
      function p(e) {
        ...
        return o.createElement(v.ContextMenuItem, {
          ...
          jsxLabel: o.createElement(
            "div",
            { className: d()(m.loaderWrap, m[t]) },
            o.createElement(u.Loader, { className: m.loader })
          ),
          noInteractive: !0,
      ...
      const S = (0, o.forwardRef)(function (e, t) {
        const { className: n, ...s } = e,
          [l, i] = (0, b.useRovingTabindexElement)(t);
        return o.createElement(v.ContextMenuItem, {
          ...s,
          className: d()(w.PLATFORM_ACCESSIBILITY_ENABLED && f.accessible, n),
          reference: l,
          tabIndex: i,
          onKeyDown: function (e) {
            if (
              !w.PLATFORM_ACCESSIBILITY_ENABLED ||
          ...
          "data-role": w.PLATFORM_ACCESSIBILITY_ENABLED ? "menuitem" : void 0,
          "aria-disabled":
            (w.PLATFORM_ACCESSIBILITY_ENABLED && e.disabled) || void 0,
        });
      });
      class y extends o.PureComponent {
              ...
              (function (e, t, n = { x: 0, y: 10 }) {
                if (t) {
                  const {
                    ...
                    i = { x: n - e, y: s },
                    a = { x: o, y: s };
                  return (0, r.isRtl)() ? (n <= e ? a : i) : l - o >= e ? a : i;
                }
                return n;
        ...
        render() {
          var e, t;
          const n = (
            null === (e = this.context) || void 0 === e ? void 0 : e.current
          )
            ? this.context.current === this.props.action.id
            : this.props.isSubMenuOpened;
          return this.state.loading
            ? o.createElement(p, { size: this.state.size })
            : o.createElement(
                S,
                {
                ...
                o.createElement(
                  ...
                  !e &&
                    ...
                    o.createElement(h.Hint, {
                      className: s(l && r.invisibleHotkey),
                      text: t,
                    }),
    ...
    91561: (e, t, n) => {
      "use strict";
      n.d(t, { ContextMenu: () => M, OverlapContextMenu: () => _ });
      var o = n(50959),
        s = n(97754),
        l = n.n(s),
        i = n(86431),
      ...
      function w(e) {
        ...
        const n =
          ...
          [s, l] = (0, o.useState)(() => n.getState()),
          [i, a] = (0, o.useState)(!1),
          r = !!s.subItems.length,
          c = r && i;
        return (
          (0, o.useEffect)(() => {
            const e = () => l(n.getState());
            return (
          ...
          o.createElement(
            p.ContextMenuItem,
            {
              ...
              onClick: function (e) {
                ...
                s.doNotCloseOnClick || (0, b.globalCloseMenu)();
                n.execute();
              },
              isLoading: s.loading,
              isHovered: c,
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            t.map((e) => {
              switch (e.type) {
                case "action":
                  return o.createElement(w, { key: e.id, action: e });
                case "separator":
                            ...
                            (t) =>
                              o.createElement(
                                a.Menu,
                                {
                                  ...p,
                                  reference: t,
                                  className: l()(C.menu, "context-menu"),
                                  onClose: this._handleClose,
    ...
    99025: (e, t, n) => {
      ...
      function a(e) {
        ...
        return o.createElement("span", { className: l()(i.shortcut, n) }, t);
      }
    },
    23829: (e, t, n) => {
      "use strict";
      ...
      function m(e) {
        const {
          ...
          H = (0, o.useContext)(r.EmptyIconsContext),
          L = !!E.length;
        return s
          ? o.createElement(
              "li",
              { className: l()(t, v.item, v.loading, v[I]) },
          ...
          : o.createElement(
              ...
              L && o.createElement(i.Icon, { className: v.nested, icon: d }),
              M
            );
      }
    },
    ...
    41590: (e, t, n) => {
      ...
      function u(e) {
        const {
          ...
          p = (0, s.ensureNotNull)((0, o.useContext)(r.DrawerContext)),
          [g] = (0, o.useState)(() => (0, i.randomHash)()),
          b = (0, o.useRef)(null),
          w = (0, o.useContext)(c.CloseDelegateContext);
        return (
          (0, o.useLayoutEffect)(
            () => (
              (0, s.ensureNotNull)(b.current).focus({ preventScroll: !0 }),
              w.subscribe(p, n),
              p.addDrawer(g),
              () => {
                p.removeDrawer(g), w.unsubscribe(p, n);
              }
            ),
            []
          ),
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(
                v,
                {
                  className: l(m.drawer, d[`position${t}`], u),
                  ref: b,
    ...
    96040: (e, t, n) => {
      ...
      function c(e) {
        ...
        return s.createElement(i.Icon, {
          ...
          onClick: h,
          onMouseDown: d,
          title: u || o.t(null, void 0, n(34596)),
        });
      }
    },
    40173: (e, t, n) => {
      ...
      function r(e) {
        ...
        switch ((0, o.mapKeyCodeToDirection)(n)) {
          case "inlinePrev":
            if (!p.length) return;
            e.preventDefault(),
              w(0 === g ? r[m] : b ? h(p, g, -1) : p[p.length - 1]);
            break;
          case "inlineNext":
            if (!p.length) return;
            e.preventDefault(),
              g === p.length - 1 ? w(r[m]) : w(b ? h(p, g, 1) : p[0]);
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = h(r, m, -1);
    ...
    28127: (e, t, n) => {
      ...
      class a extends o.PureComponent {
        ...
        _item(e) {
          ...
          switch (e.type) {
            case "separator":
              return o.createElement(l, { key: e.id, hint: e.getHint() });
            case "action":
    ...
    65890: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 9" width="11" height="9" fill="none"><path strokeWidth="2" d="M0.999878 4L3.99988 7L9.99988 1"/></svg>';
    },
    66493: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16.5 20L11 14.5 16.5 9"/></svg>';
    },
    79978: (e) => {
      e.exports =
    ...
    39956: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28"><g fill="none" stroke="currentColor" strokeLinecap="square"><path d="M10.5 7.5v15M7.5 20.5H10M13.5 11.5H11M19.5 6.5v15M16.5 9.5H19M22.5 16.5H20"/></g></svg>';
    },
    24464: (e) => {
      e.exports =
