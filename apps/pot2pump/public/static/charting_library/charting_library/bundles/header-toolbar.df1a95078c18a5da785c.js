  ...
  [3005],
  {
    ...
    67842: (e, t, s) => {
      ...
      var n = s(50959),
        ...
        a = s(39416);
      function o(e, t = []) {
        const { callback: s, ref: o = null } = (function (e) {
    ...
    65817: (e, t, s) => {
      ...
      var n = s(11542);
      const r = [
        { name: "", label: n.t(null, { context: "interval" }, s(37830)) },
        { name: "H", label: n.t(null, { context: "interval" }, s(5285)) },
        { name: "D", label: n.t(null, { context: "interval" }, s(6174)) },
        { name: "W", label: n.t(null, { context: "interval" }, s(25042)) },
        { name: "M", label: n.t(null, { context: "interval" }, s(79410)) },
      ];
    },
    54079: (e, t, s) => {
      "use strict";
    ...
    46618: (e, t, s) => {
      ...
      var _ = s(45601),
        ...
        C = s(59468),
        w = s(45820);
      const M = { text: E.t(null, void 0, s(55646)) };
      function I(e) {
        return n.createElement(
          "div",
          { className: C.wrap },
      ...
      const D = (function (e = T, t = A, s = W, r = N) {
        var o;
        return (
      ...
      class ve {
        ...
        _findFavIndex(e) {
          return this._favorites.findIndex((t) => e === pe(t));
        }
      }
      function pe(e) {
    ...
    61380: (e) => {
      e.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 10" width="20" height="10"><path fill="none" stroke="currentColor" strokeWidth="1.5" d="M2 1l8 8 8-8"/></svg>';
    },
    45820: (e) => {
      e.exports =
