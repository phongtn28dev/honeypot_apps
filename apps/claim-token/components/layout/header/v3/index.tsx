...
import { WalletConnect } from '@honeypot/shared/components/walletconnect/v3';
import { Menu } from '@honeypot/shared/config';
import { DOMAIN_MAP } from '@honeypot/shared/config';
...
export const Header = (
  props: HtmlHTMLAttributes<any> & { showProfile?: boolean }
) => {
  ...
  return (
    <div className={clsx('relative', props.className)}>
      ...
      >
        ...
        {!isMenuOpen && <WalletConnect showProfile={props.showProfile} />}
