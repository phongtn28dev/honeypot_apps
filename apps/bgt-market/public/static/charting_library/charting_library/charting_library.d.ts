...
export interface IChartingLibraryWidget {
   ...
   *             }
   *         ],
   *         icon: `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"><g fill="none" stroke="currentColor"><circle cx="10" cy="10" r="2.5"/><circle cx="18" cy="18" r="2.5"/><path strokeLinecap="square" d="M17.5 7.5l-7 13"/></g></svg>`,
   *     }
   * ).then(myDropdownApi => {
